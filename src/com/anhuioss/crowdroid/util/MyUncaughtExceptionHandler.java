...
public class MyUncaughtExceptionHandler implements UncaughtExceptionHandler
{
    ...
    private static final String      BUG_REPORT_URL  = "http://218.22.178.67:8080/ErrorReportManagerServlet/bugreport";
    ...
    public void uncaughtException(Thread th, Throwable t)
    {
        ...
        this.mDefaultUEH.uncaughtException(th, t);
    }
    ...
    public static final void showBugReportDialogIfExist(final Context context)
    {
        ...
        if (file != null & file.exists())
        {
            ...
            builder.setTitle(R.string.dialog_myuncatchexceptionhandler_bugreport);
            builder.setMessage(R.string.dialog_myuncatchexceptionhandler_sendbugrport);
            ...
            builder.setPositiveButton(R.string.dialog_activity_timeline_send,
                    new OnClickListener() {
                        public void onClick(DialogInterface dialog, int which)
                        {
